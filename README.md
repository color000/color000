...
<img src="https://img.shields.io/badge/Interliij-000000?style=flat&logo=Interliij&logoColor=white" /> 
...
회원가입, 로그인, 자동로그인, 비밀번호 찾기, 프로필 및 편집, 레이아웃 분리, 프로젝트 설치
이메일 인증 파라미터 확인 후 api 전송 처리, 발급된 쿠키로 쿠키 확인 처리하여 라우터로 로그인 분기 처리, 비로그인시 화면 처리, 404페이지 처리, Axios로 api연동 하여 구현

- 🌈 22.10 삼성 SW 아카데미(LMS,CMS), 문득, 커스텀미라클(지웹)
